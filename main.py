...
######################################TO DO######################################
    ...
    # Applies Canny edge detector with minVal of 50 and maxVal of  150 (2 LINES)
...
def do_segment(frame):
    ...
    polygons = np.array([
                            [(0, height), (width, height), (int(width/2), int(height/3))]
                        ])
...
def calculate_lines(frame, lines):
    ######################################TO DO######################################
    # Empty arrays to store the coordinates of the left and right lines (2 lines)
    left    = []
    right   = []
    ...
    for line in lines:
        ...
        # Fits a linear polynomial to the x and y coordinates and returns a vector of coefficients which describe the slope and y-intercept(3 lines)
